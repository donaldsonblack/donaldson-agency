...
const TimelineWithBeam = dynamic(() =>
	import("@/components/timeline-with-beam").then((mod) => ({
		default: mod.TimelineWithBeam,
	})),
);

const ScrollVelocityContainer = dynamic(() =>
	import("@/components/ui/scroll-based-velocity").then((mod) => ({
...
const CustomerNotifications = dynamic(() =>
	import("@/components/customer-notifications").then((mod) => ({
		default: mod.CustomerNotifications,
	})),
);
					...
					<div className="container mx-auto max-w-6xl">
						<div className="text-center space-y-6">
							<div className="inline-block px-4 py-1.5 bg-muted rounded-full text-sm font-medium mb-4">
								🚀 Built for Darwin businesses in Trades, Tourism & Health
							</div>
							<h1
								id="hero-heading"
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20 max-w-5xl mx-auto">
							<div className="bg-card border border-border rounded-2xl p-6 hover:border-primary/50 transition-colors flex items-start gap-4">
								...
								<div>
									<h3 className="text-xl font-bold mb-3">
										100% Trackable Results
									</h3>
									<p className="text-muted-foreground">
										Every campaign includes call logs, booking data &
							...
							<div className="bg-card border border-border rounded-2xl p-6 hover:border-primary/50 transition-colors flex items-start gap-4">
								...
								<div>
									<h3 className="text-xl font-bold mb-3">
										Local Presence, Lean Team
									</h3>
									<p className="text-muted-foreground">
										One team member on the ground in Darwin, two remote
										specialists.
									</p>
								</div>
							</div>
						...
						<div className="grid md:grid-cols-3 gap-8">
							<ScaleIn delay={0.1}>
								<div className="p-8 rounded-2xl border border-border hover:border-primary/50 transition-colors h-full">
									...
									<p className="text-muted-foreground mb-4">
										Data-driven campaigns that deliver consistent, scalable
							...
							<ScaleIn delay={0.2}>
								<div className="p-8 rounded-2xl border border-border hover:border-primary/50 transition-colors h-full">
									...
									<p className="text-muted-foreground mb-4">
										Build a brand that resonates with your audience and stands
										out in the market
									</p>
									<ul className="space-y-2 text-sm">
										<li className="flex items-center gap-2">
				...
				<section className="py-20 px-4 bg-background">
					<div className="container mx-auto max-w-6xl">
						<AnimatedSection className="text-center mb-16">
							...
							<p className="text-xl text-muted-foreground max-w-2xl mx-auto">
								Stay updated with instant notifications as your campaigns drive
								leads, conversions, and growth
							</p>
						</AnimatedSection>
				...
				<section className="bg-muted py-20 px-4 overflow-hidden">
					<div className="container mx-auto max-w-6xl mb-12">
						<AnimatedSection className="text-center">
							<h2 className="text-4xl md:text-5xl font-bold mb-4">
								Why Top End Businesses Choose Donaldson Marketing
							</h2>
						</AnimatedSection>
					</div>
						...
						<ScrollVelocityContainer className="w-full">
							...
							>
								{[...Array(3)]
									.flatMap(() => [
										{
											title: "Built for Darwin, Not the East Coast",
											description:
												"Every strategy we use is shaped around local seasonality, weather patterns, and how business is actually done in the Territory. (Trades, Tourism, Health — our three validated niches.)",
										},
										{
											title: "100% Trackable Results",
											description:
												"Every campaign includes call logs, booking data, and transparent reporting. No guesswork.",
										},
										{
											title: "Low-Risk, Proof-First Engagements",
											description:
							...
							>
								{[...Array(3)]
									.flatMap(() => [
										{
											title: "AHPRA-Safe & Compliance-First",
											description:

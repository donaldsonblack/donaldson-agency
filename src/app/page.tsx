					...
					<div className="container mx-auto max-w-7xl">
						...
						<div className="grid md:grid-cols-3 gap-8 mb-12">
							...
							<div className="bg-card border border-border rounded-2xl p-8 hover:border-primary/50 transition-colors">
								...
								<h3 className="text-2xl font-bold mb-4">Tourism & Hospitality</h3>
								<p className="text-muted-foreground mb-4">
						...
						<div className="space-y-8 max-w-4xl mx-auto">
							...
							<div className="flex gap-6 items-start">
								...
								<div>
									...
									<p className="text-muted-foreground">
										Design your niche-specific program based on your numbers. Map
										the funnel: ads/search → landing/calls → booking and
										follow-up.
									</p>
								</div>
							</div>
					...
					<div className="container mx-auto max-w-6xl">
						...
						<div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
							...
							<div className="bg-card border border-border rounded-xl p-8">
								...
								<h3 className="text-xl font-bold mb-3">Capacity-aware scaling</h3>
								<p className="text-muted-foreground">
								...
								<div>
									...
									<ul className="space-y-3">
										<li className="flex items-start gap-3">
											...
											<span className="text-muted-foreground">
												Quick review of current leads, jobs, patients or bookings
											</span>
										</li>
										<li className="flex items-start gap-3">
											<CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
